...
class ImagenComun:
    ...
    def dibujar_forma(self, forma, texto, umbral, kernel_size):
        ...
        if forma == 'circulo':
            ...
            radio = min(centro) - 20
            cv2.circle(img_color, centro, radio, (30, 255, 255), 2)
            x_texto = centro[0] - ancho_texto // 2
            y_texto = centro[1] + alto_texto // 2
            cv2.putText(img_color, texto_completo, (x_texto, y_texto), fuente, escala, (30, 255, 255), grosor)

        elif forma == 'cuadrado':
            inicio = (20, 20)
            fin = (ancho_img - 20, alto_img - 20)
            cv2.rectangle(img_color, inicio, fin, (30, 255, 255), 2)
